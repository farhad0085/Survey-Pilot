      ...
      getPoll(pollId)
        .then((res) => {
          ...
          formik.setValues({
            ...
            publishAt: pollDetails.publish_at ? convertDatetimeForInput(pollDetails.publish_at) : '',
            expireAt: pollDetails.expire_at ? convertDatetimeForInput(pollDetails.expire_at) : '',
